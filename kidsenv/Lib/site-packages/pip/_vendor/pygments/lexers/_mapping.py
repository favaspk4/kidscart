...
LEXERS = {
    ...
    'CSSUL4Lexer': ('pip._vendor.pygments.lexers.ul4', 'CSS+UL4', ('static+ul4',), ('*.cssul4',), ()),
    ...
    'CssDjangoLexer': ('pip._vendor.pygments.lexers.templates', 'CSS+Django/Jinja', ('static+django', 'static+jinja'), ('*.static.j2', '*.static.jinja2'), ('text/static+django', 'text/static+jinja')),
    'CssErbLexer': ('pip._vendor.pygments.lexers.templates', 'CSS+Ruby', ('static+ruby', 'static+erb'), (), ('text/static+ruby',)),
    'CssGenshiLexer': ('pip._vendor.pygments.lexers.templates', 'CSS+Genshi Text', ('static+genshitext', 'static+genshi'), (), ('text/static+genshi',)),
    'CssLexer': ('pip._vendor.pygments.lexers.static', 'CSS', ('static',), ('*.static',), ('text/static',)),
    'CssPhpLexer': ('pip._vendor.pygments.lexers.templates', 'CSS+PHP', ('static+php',), (), ('text/static+php',)),
    'CssSmartyLexer': ('pip._vendor.pygments.lexers.templates', 'CSS+Smarty', ('static+smarty',), (), ('text/static+smarty',)),
    ...
    'LassoCssLexer': ('pip._vendor.pygments.lexers.templates', 'CSS+Lasso', ('static+lasso',), (), ('text/static+lasso',)),
    ...
    'LessCssLexer': ('pip._vendor.pygments.lexers.static', 'LessCss', ('less',), ('*.less',), ('text/x-less-static',)),
    ...
    'MakoCssLexer': ('pip._vendor.pygments.lexers.templates', 'CSS+Mako', ('static+mako',), (), ('text/static+mako',)),
    ...
    'MozPreprocCssLexer': ('pip._vendor.pygments.lexers.markup', 'CSS+mozpreproc', ('static+mozpreproc',), ('*.static.in',), ()),
    ...
    'MyghtyCssLexer': ('pip._vendor.pygments.lexers.templates', 'CSS+Myghty', ('static+myghty',), (), ('text/static+myghty',)),
    ...
    'SassLexer': ('pip._vendor.pygments.lexers.static', 'Sass', ('sass',), ('*.sass',), ('text/x-sass',)),
    ...
    'ScssLexer': ('pip._vendor.pygments.lexers.static', 'SCSS', ('scss',), ('*.scss',), ('text/x-scss',)),
